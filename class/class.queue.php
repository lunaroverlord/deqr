...
class Queue{
  ...
  public static function create($name, $estimated_service_time){
    ...
    $stmt = $mysqli->query("INSERT INTO queues(`name`, `estimated_service_time`,`current_number`,`last_customer_number`, `token`, `last_service_time`) VALUES('$name', '$estimated_service_time', 1, 0, '$token', NOW())");
    /*
