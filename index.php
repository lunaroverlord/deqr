<?php
/*
 * Server-side processing for the DeQR service
 */


// Status is either "polling" or "default"
$status = "default";
$queue = "";
...
<body>
	...
	<?
	// Default view - gives options to create of join
	if($status == "default")
	{ ?>
	...
	<? }
	// Otherwise, if you're a joined client, display various status fields and controls, including BrainTree
